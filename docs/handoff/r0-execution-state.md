...
1. 选择 `R0-SCI-004` 作为下一条可执行科学主线，先窄复核现有 CAVH 公式、fixture、Legacy provenance 和当前 consumer，再交付第一份独立 formula/guidance oracle slice。
2. 产品 schema、loader、Compiler、Session、durable evidence、gate、性能与架构治理继续保持锁定；一次只推进一条 R0 主线。
